...
export default function Navbar() {
  ...
  const textColor =
    isLanding && !scrolled ? "text-white" : "text-gray-700 dark:text-gray-200";
  const logoColor =
    isLanding && !scrolled ? "text-white" : "text-blue-600 dark:text-blue-400";
  const themeButtonBg =
    "bg-gray-100 hover:bg-gray-200 text-gray-700 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-gray-200 border border-transparent";
