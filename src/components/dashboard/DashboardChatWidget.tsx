...
const DashboardChatWidget = forwardRef<{ openChat: () => void }, {}>(
  function DashboardChatWidget(_props, ref) {
    ...
    useEffect(() => {
      // Initialize threads + active thread when user changes.
    ...
    return (
      <>
        {open && (
          <div className="fixed z-[120] sm:right-4 sm:top-4 right-0 bottom-0 sm:bottom-auto sm:w-[380px] w-full h-dvh sm:h-auto sm:rounded-3xl bg-white dark:bg-slate-900 backdrop-blur border border-gray-100 dark:border-slate-800 shadow-xl overflow-hidden flex flex-col transition-colors">
            <div className="px-5 py-4 border-b border-gray-100 dark:border-slate-800 flex items-center justify-between gap-3 transition-colors">
              ...
              <div className="flex items-center gap-2">
                <select
                  ...
                  className="px-2 py-1.5 rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-[11px] font-semibold text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-colors"
                ...
                <button
                  type="button"
                  onClick={onNewChat}
                  className="px-2 py-1.5 rounded-xl bg-gray-100 dark:bg-slate-800 hover:bg-gray-200 dark:hover:bg-slate-700 text-[11px] font-semibold text-gray-700 dark:text-gray-300 transition-colors"
                  title="Chat baru"
                >
                  Baru
                </button>
                  ...
                  return (
                    ...
                    >
                      <div className="max-w-[85%]">
                        <div
                          className={`rounded-2xl px-4 py-3 text-sm leading-relaxed whitespace-pre-wrap break-words [overflow-wrap:anywhere] border transition-colors ${
                            isUser
