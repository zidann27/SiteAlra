...
export default function HeroSection() {
  ...
  // Hero animasi masuk saat halaman load (bukan scroll)
    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 w-full">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <SmartCTALink className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-blue-600/25 hover:shadow-blue-500/30 hover:-translate-y-0.5 text-base">
              Buat Website Gratis
              <ArrowRight size={18} />
            </SmartCTALink>
            <a
          ...
          <div className="relative bg-slate-800/80 backdrop-blur rounded-2xl border border-slate-700/50 shadow-2xl overflow-hidden">
            ...
            <div className="aspect-[16/7] bg-gradient-to-br from-amber-50 to-orange-50 flex items-center justify-center relative overflow-hidden">
              <div className="absolute inset-0 w-[200%] h-full flex animate-hero-loop-left opacity-40">
                <img src={previewImage} alt="Preview website" className="w-1/2 h-full object-cover flex-shrink-0" />
                <img src={previewImage} alt="Preview website" className="w-1/2 h-full object-cover flex-shrink-0" />
              </div>
              <div className="relative z-10 text-center px-8">
                ...
                <div className="mt-4 inline-block bg-amber-600 text-white px-5 py-2 rounded-lg text-sm font-semibold">Lihat Menu</div>
              </div>
            </div>
          </div>
        </div>
