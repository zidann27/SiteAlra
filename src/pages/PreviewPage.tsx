...
import {
  Eye, Rocket, ArrowLeft, Copy, CheckCheck, Loader2,
...
export default function PreviewPage() {
  ...
  const handleDeploy = async () => {
    ...
    try {
      ...
      setDeployError('Gagal deploy website. Silakan coba lagi.');
      setIsDeploying(false);
    }
  };
        ...
        <div className="bg-green-50 border-b border-green-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-col sm:flex-row items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-green-700 font-semibold text-sm">Website berhasil di-deploy!</span>
            </div>
            <div className="flex items-center gap-2">
              ...
              >
                {copied ? <><CheckCheck size={13} /> Tersalin!</> : <><Copy size={13} /> Salin URL</>}
              </button>
            </div>
          </div>
        </div>
